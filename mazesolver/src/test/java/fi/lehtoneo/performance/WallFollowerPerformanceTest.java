...
public class WallFollowerPerformanceTest {
    ...
    public void runPerfTests() {
        System.out.println("Wall Follower's performance tests starting, this might take a while...");
        long n = 300;
        long a = 0;
        for(int i = 0; i < sizes.length; i++) {
            ...
            while(a < n) {
                ...
                WallFollower wf = new WallFollower(p.getGrid(), startPoint, endPoint);
    ...
    public void showResults() {
        System.out.println("Wall Follower performance results: ");
        System.out.println("");
        for(int i = 0; i < sizes.length; i++) {
